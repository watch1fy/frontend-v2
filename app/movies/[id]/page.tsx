...
import { getMovieById, getMovieImages, getMovieReviews, getMovieVideos, getSimilarMovies } from '@/lib/functions/'
...
const Watch = async ({ params }: { params: { id: number } }) => {
  const { movie, similarMovies, images, videos, reviews } = await getAllMovieDetails(params.id as number)
