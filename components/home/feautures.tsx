      ...
      <Accordion selectionMode='multiple' variant='splitted'>
        {
          ...
          <AccordionItem className=' text-gray-500 dark:text-gray-400' key={idx} title={feature.heading}>
              ...
              <div className='md:w-[50%] w-full flex flex-col justify-between gap-4'>
                <p className='w-full'>{feature.content}</p>
                  <Link href={'#'} className='md:w-fit'>
                    <Button variant="flat" color="default" radius="lg" size="lg" className="md:w-[200px] w-full text-lg flex gap-4">
                      Know More
                      <MdArrowForward size={22} className="rotate-[315deg] scale-150 text-primary" />
                    </Button>
                  </Link>
              </div>
              <Image
