    ...
    <section
      ...
      <div className="flex flex-col gap-2 items-center">
        <div className="flex flex-row gap-4 justify-between w-full items-start">
          <p className="text-xl md:text-3xl font-medium">Join Watchify Now!</p>
          <Button
            color="primary"
            variant="ghost"
            size="md"
        ...
        <p className="text-md md:text-xl text-center">Sign up for Watchify and start syncing your watch parties!</p>
      </div>
